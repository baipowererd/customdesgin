...
.card-glass-sky:hover {
  transform: scale(1.03);
}
.card-glass-sky::before {
  content: '';
  position: absolute;
  top: -50%; left: -50%;
...
.card-glass-sky .glass-title {
  font-size: 20px; font-weight: 600; color: #fff;
  margin-bottom: 8px;
  position: relative; z-index: 1;
}
.card-glass-sky .glass-desc {
  font-size: 14px; color: rgba(255,255,255,0.6);
  line-height: 1.6;
  position: relative; z-index: 1;
}
`;
export default SkyGlassCard;
